...
UserModel* mbs_new_user_model() 
{
    ...
    um->FrontTire_rem.R = 0.0;
    um->FrontTire_rem.K = 0.0;
 ...
 void mbs_load_user_model_xml(MbsInfos* mbs_infos, UserModel* um) 
{
    ...
    um->FrontTire_rem.R = mbs_infos->user_models->user_model_list[7]->parameter_list[0]->value_list[1];
    um->FrontTire_rem.K = mbs_infos->user_models->user_model_list[7]->parameter_list[1]->value_list[1];
 ...
 void mbs_bind_user_model(MbsInfos* mbs_infos, UserModel* um) 
{
    ...
    mbs_infos->user_models->user_model_list[7]->parameter_list[0]->val_ptr = &um->FrontTire_rem.R;
    mbs_infos->user_models->user_model_list[7]->parameter_list[1]->val_ptr = &um->FrontTire_rem.K;
 ...
 void mbs_print_user_model(UserModel* um) 
{
    ...
    printf("user_model->FrontTire_rem.R=%f\n", um->FrontTire_rem.R);
    printf("user_model->FrontTire_rem.K=%f\n", um->FrontTire_rem.K);
