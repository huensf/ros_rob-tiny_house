...
// Link Kinematics: Distance Z , Relative Velocity ZD 
  ...
  RLlnk1_281 = s->dpt[2][33]*C18;
  RLlnk1_381 = s->dpt[2][33]*S18;

// = = Block_0_1_0_0_2_6 = = 
 
// Link Kinematics: Distance Z , Relative Velocity ZD 

  RLlnk3_283 = s->dpt[2][35]*C19;
  RLlnk3_383 = s->dpt[2][35]*S19;

// = = Block_0_1_0_0_3_7 = = 
 
// Link Kinematics: Distance Z , Relative Velocity ZD 

  RLlnk5_285 = s->dpt[2][37]*C20;
  RLlnk5_385 = s->dpt[2][37]*S20;

// = = Block_0_1_0_0_4_8 = = 
 
// Link Kinematics: Distance Z , Relative Velocity ZD 

  RLlnk6_286 = s->dpt[2][39]*C21;
  RLlnk6_386 = s->dpt[2][39]*S21;

// = = Block_0_1_0_1_1_5 = = 
 
// Link Kinematics: Distance Z , Relative Velocity ZD 

  Plnk21 = RLlnk1_281-s->dpt[2][11]+s->dpt[2][3];
  Plnk31 = RLlnk1_381-s->dpt[3][11];
  Z1 = sqrt(Plnk21*Plnk21+Plnk31*Plnk31);
  e21 = Plnk21/Z1;
  e31 = Plnk31/Z1;
  Zd1 = qd[18]*(RLlnk1_281*e31-RLlnk1_381*e21);
...
// Link Kinematics: Distance Z , Relative Velocity ZD 
  ...
  Plnk22 = RLlnk3_283-s->dpt[2][14]+s->dpt[2][4];
  Plnk32 = RLlnk3_383-s->dpt[3][14];
  Z2 = sqrt(Plnk22*Plnk22+Plnk32*Plnk32);
  e22 = Plnk22/Z2;
  e32 = Plnk32/Z2;
  Zd2 = qd[19]*(RLlnk3_283*e32-RLlnk3_383*e22);
...
// Link Kinematics: Distance Z , Relative Velocity ZD 
  ...
  Plnk23 = RLlnk5_285+s->dpt[2][5]-s->dpt[2][6];
  Plnk33 = RLlnk5_385-s->dpt[3][6];
  Z3 = sqrt(Plnk13*Plnk13+Plnk23*Plnk23+Plnk33*Plnk33);
  e13 = Plnk13/Z3;
  e23 = Plnk23/Z3;
  e33 = Plnk33/Z3;
  Zd3 = qd[20]*(RLlnk5_285*e33-RLlnk5_385*e23);
...
// Link Kinematics: Distance Z , Relative Velocity ZD 
  ...
  Plnk24 = -(RLlnk6_286-s->dpt[2][10]+s->dpt[2][7]);
  Plnk34 = -(RLlnk6_386-s->dpt[3][10]);
  Z4 = sqrt(Plnk14*Plnk14+Plnk24*Plnk24+Plnk34*Plnk34);
  e14 = Plnk14/Z4;
  e24 = Plnk24/Z4;
  e34 = Plnk34/Z4;
  Zd4 = -qd[21]*(RLlnk6_286*e34-RLlnk6_386*e24);
...
// Link Dynamics : Forces projection on body-fixed frames 
  ...
  trq[1][18] = s->trq[1][18]-fSlnk31*s->dpt[2][33];
...
// Link Dynamics : Forces projection on body-fixed frames 
  ...
  trq[1][19] = s->trq[1][19]-fSlnk32*s->dpt[2][35];
...
// Link Dynamics : Forces projection on body-fixed frames 
  ...
  trq[1][20] = s->trq[1][20]-fSlnk33*s->dpt[2][37];
  trq[3][20] = s->trq[3][20]+fSlnk13*s->dpt[2][37];
...
// Link Dynamics : Forces projection on body-fixed frames 
  ...
  trq[1][21] = s->trq[1][21]+fPlnk34*s->dpt[2][39];
  trq[3][21] = s->trq[3][21]-fPlnk14*s->dpt[2][39];
